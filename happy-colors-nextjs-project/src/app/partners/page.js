...
export default function Partners() {
    return (
        <>
            ...
            <p>
                Happy Colors е място за ръчно изработени изделия, създадени с внимание, любов и личен подход. С радост каним творци, занаятчии и малки брандове, които споделят тези ценности и биха искали да предложат своята продукция в нашия онлайн магазин.
            </p>
            <p>
                Ако създаваш ръчно изработени играчки, аксесоари или други красиви и смислени изделия и търсиш място, където трудът ти да бъде представен с грижа и уважение — ще се радваме да се свържеш с нас.
            </p>
            <Link href="/contacts">Свържи се с мен 
